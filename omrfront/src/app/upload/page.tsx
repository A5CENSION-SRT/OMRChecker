...
import { UploadAnswersZone } from "@/components/UploadAnswersZone";
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            Select multiple OMR images to process in batch
          </p>
        </div>

        {/* Upload Zone */}
        <div className="flex justify-center grid-cols-2 gap-5">
